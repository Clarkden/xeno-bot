...
async def give_sub(ctx, length, member: discord.Member):
    ...
    r = requests.post('https://api.c0gnito.cc/generate-keys', data={'privateKey':'knPkhH2CuVU7qWMtibkvp3jwHtLn1c7MMxUkkyunLC7NWnlmQ0qRePqwH251FHl3', 'numberOfLicenses': '1', 'expiryTime':f'0'})
